...
class Restaurante:
    ...
    def listar_restaurantes(cls):
        ...
        for restaurante in cls.restaurantes:
            print(f'{restaurante._nome.ljust(25)} | {restaurante._categoria.ljust(25)} | {restaurante.ativo.ljust(25)} | {restaurante.media_avalicao}')
    ...
    def media_avalicao(self):
        ...
        if not self._avalicao:
            return 'nenhuma avaliação disponivel'
